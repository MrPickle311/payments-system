...
import static com.example.payments.payment.domain.enums.PaymentState.AUTH_REJECTED;
import static com.example.payments.payment.domain.enums.PaymentState.FRAUD_DETECTED;
import static com.example.payments.payment.domain.enums.PaymentState.FRAUD_PASSED;
import static com.example.payments.payment.domain.enums.PaymentState.LIMITS_EXCEEDED;
import static com.example.payments.payment.domain.enums.PaymentState.LIMITS_OK;
import static com.example.payments.payment.domain.enums.PaymentState.PROCESSING;
import static com.example.payments.payment.domain.enums.PaymentState.SANCTIONS_CLEARED;
import static com.example.payments.payment.domain.enums.PaymentState.SANCTIONS_HIT;
...
public class ParallelSagaJoinInterceptor
  ...
  private static final Set<PaymentState> SUCCESS_STATES =
      EnumSet.of(AUTH_APPROVED, FRAUD_PASSED, LIMITS_OK, SANCTIONS_CLEARED);

  private static final Set<PaymentState> FAILURE_STATES =
      EnumSet.of(AUTH_REJECTED, FRAUD_DETECTED, LIMITS_EXCEEDED, SANCTIONS_HIT);
  ...
  private void checkParallelJoinForAllRegions(
    ...
    if (regions == null || regions.size() < 4) {
      return;
    }
