...
class PaymentControllerTest {
  ...
  private static final Long SOURCE_USER_ID = 101L;
  private static final Long TARGET_USER_ID = 202L;
  ...
  private ApiCreatePaymentRequest createRequest() {
    ...
    req.setCurrency(USD);
    req.setSourceUserId(SOURCE_USER_ID);
    req.setTargetUserId(TARGET_USER_ID);
    req.setSourceCurrency(USD);
  ...
  private Payment createPayment() {
    ...
    p.setSourceUserId(SOURCE_USER_ID);
    p.setTargetUserId(TARGET_USER_ID);
    p.setSourceCurrency(USD);
    p.setTargetCurrency(EUR);
